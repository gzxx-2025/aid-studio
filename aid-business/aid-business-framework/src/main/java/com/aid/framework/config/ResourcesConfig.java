...
import com.aid.framework.interceptor.CaptchaInterceptor;
import com.aid.framework.interceptor.RepeatSubmitInterceptor;
...
public class ResourcesConfig implements WebMvcConfigurer
{
    ...
    /** 行为验证码拦截器（对 @CaptchaRequired 标注的接口做人机校验） */
    @Autowired
    ...
    public void addResourceHandlers(ResourceHandlerRegistry registry)
    {
        ...
        registry.addResourceHandler(Constants.RESOURCE_PREFIX + "/**")
                .addResourceLocations("file:" + AidAppConfig.getProfile() + "/");
    ...
    public void addInterceptors(InterceptorRegistry registry)
    {
        ...
        // 行为验证码拦截器：仅对 @CaptchaRequired 接口生效，内部按配置判定是否真正校验
